...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (firstPara && readingTime > 0) {
    ...
    timeInfo.style.cssText =
      "text-align: center; color: #F4A300; font-weight: 600; font-size: 0.9rem; margin-top: 0.5rem;";
    timeInfo.innerHTML = `⏱️ Estimated reading time: ${readingTime} minute${
      readingTime > 1 ? "s" : ""
    }`;
...
const activityDescriptions = {
  ...
  "Temple of the Tooth Relic":
    "Sacred Buddhist temple housing tooth relic of Buddha",
